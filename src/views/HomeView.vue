...
for a specific house by typing in the searchbar. Here the user can even create a house-->
  <div class="home">
    <div class="first-block">
      <h1>Houses</h1>
      <router-link to="/houseForm"><button>+ CREATE NEW</button></router-link>
    </div>
    ...
    <div class="second-block">
      ...
      <div>
        ...
        <button @click="sortByPrice" class="button1">Price</button>
        <button @click="sortBySize" class="button2">Size</button>
      </div>
    </div>
